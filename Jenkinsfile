def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.1.7-FEBRUARY-DRY-RUN",
                               "Mule-runtime/mule-api/1.1.6-FEBRUARY-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.1.7-FEBRUARY-DRY-RUN",

def UPSTREAM_PROJECTS_LIST = [ "Mule-runtime/metadata-model-api/1.2.0-MARCH-DRY-RUN",
                               "Mule-runtime/mule-api/1.2.0-MARCH-DRY-RUN",
                               "Mule-runtime/mule-extensions-api/1.2.0-MARCH-DRY-RUN",
